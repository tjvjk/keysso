...
from .....types.report.simple import context_retrieve_concurents_params
from .....types.report.simple.context_retrieve_concurents_response import ContextRetrieveConcurentsResponse
...
class ContextResource(SyncAPIResource):
    ...
    ) -> ContextRetrieveConcurentsResponse:
        """
        Пример запроса
        `https://api.keys.so/report/simple/context/concurents?base=msk&domain=wildberries.ru&sort=cnt%7Casc&page=1&per_page=25`
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    context_retrieve_concurents_params.ContextRetrieveConcurentsParams,
                ),
            ),
            cast_to=ContextRetrieveConcurentsResponse,
        )
...
class ContextResourceWithRawResponse:
    def __init__(self, context: ContextResource) -> None:
        ...
        self.retrieve_concurents = to_raw_response_wrapper(
            context.retrieve_concurents,
        )

    @cached_property
    def keywords(self) -> KeywordsResourceWithRawResponse:
        return KeywordsResourceWithRawResponse(self._context.keywords)

    @cached_property
    def ads(self) -> AdsResourceWithRawResponse:
        return AdsResourceWithRawResponse(self._context.ads)
...
class AsyncContextResourceWithRawResponse:
    ...
    def keywords(self) -> AsyncKeywordsResourceWithRawResponse:
        return AsyncKeywordsResourceWithRawResponse(self._context.keywords)

    @cached_property
    def ads(self) -> AsyncAdsResourceWithRawResponse:
        return AsyncAdsResourceWithRawResponse(self._context.ads)
...
class ContextResourceWithStreamingResponse:
    ...
    def keywords(self) -> KeywordsResourceWithStreamingResponse:
        return KeywordsResourceWithStreamingResponse(self._context.keywords)

    @cached_property
    def ads(self) -> AdsResourceWithStreamingResponse:
        return AdsResourceWithStreamingResponse(self._context.ads)
...
class AsyncContextResourceWithStreamingResponse:
    ...
    def keywords(self) -> AsyncKeywordsResourceWithStreamingResponse:
        return AsyncKeywordsResourceWithStreamingResponse(self._context.keywords)

    @cached_property
    def ads(self) -> AsyncAdsResourceWithStreamingResponse:
        return AsyncAdsResourceWithStreamingResponse(self._context.ads)
