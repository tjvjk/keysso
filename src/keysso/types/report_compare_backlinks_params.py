...
__all__ = ["ReportCompareBacklinksParams"]


class ReportCompareBacklinksParams(TypedDict, total=False):
    excl: Required[str]
    ...
    """
    Тип отчета `backlinks`, для данного инструмента необходимо явно указывать данный
    тип отчета
    """
