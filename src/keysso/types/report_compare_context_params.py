...
__all__ = ["ReportCompareContextParams"]


class ReportCompareContextParams(TypedDict, total=False):
    excl: Required[str]
    ...
    """
    Тип отчета `context`, для данного инструмента необходимо явно указывать данный
    тип отчета
    """
