...
__all__ = ["OwnerRetrieveSubdomainsResponse", "Data"]
...
class Data(BaseModel):
    ...
    rsya: Optional[int] = None
    """Количество объявлений РСЯ Возможность фильтровать по полю: `да`"""

    vis: Optional[int] = None
    """Оценка трафика с поиска Возможность фильтровать по полю: `да`"""


class OwnerRetrieveSubdomainsResponse(BaseModel):
