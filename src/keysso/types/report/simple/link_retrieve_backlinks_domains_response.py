...
__all__ = ["LinkRetrieveBacklinksDomainsResponse", "Data"]
...
class Data(BaseModel):
    ...
    """Всего ссылающихся ip. Возможность фильтровать по полю: `да`"""
    ...
    """Количество активных исходящих ссылок с домена, всего.

    Возможность фильтровать по полю: `да`
    """

    outlinks_archive_count: Optional[int] = None
    """Количество архивных исходящих ссылок с домена, всего.

    Возможность фильтровать по полю: `да`
    """

    outlinks_count: Optional[int] = None
    """Количество исходящих ссылок с домена, всего.
    ...
    total_backdomains_count: Optional[int] = None
    """Входящих ссылок всего. Возможность фильтровать по полю: `да`"""

    total_outdomains_count: Optional[int] = None
    """Исходящих ссылок всего Возможность фильтровать по полю: `да`"""
...
class LinkRetrieveBacklinksDomainsResponse(BaseModel):
