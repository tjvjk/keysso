...
__all__ = ["LinkRetrieveOutlinksDomainsResponse", "Data"]
...
class Data(BaseModel):
    ...
    """Количество активных входящих ссылок на домен, всего.

    Возможность фильтровать по полю: `да`
    """

    backlinks_archive_count: Optional[int] = None
    """Количество архивных входящих ссылок на домен, всего.

    Возможность фильтровать по полю: `да`
    """

    backlinks_count: Optional[int] = None
    """Количество входящих ссылок на домен, всего.
...
class LinkRetrieveOutlinksDomainsResponse(BaseModel):
