...
__all__ = ["LinkRetrieveOutlinksDomainsViewDomainResponse", "Data"]
...
class Data(BaseModel):
    ...
    backlinks_active_count: Optional[int] = None
    """
    Количество активных входящих ссылок с домена на анализируемый домен. Возможность
    фильтровать по полю: `да`
    """

    backlinks_archive_count: Optional[int] = None
    """
    Количество архивных входящих ссылок с домена на анализируемый домен. Возможность
    фильтровать по полю: `да`
    """

    backlinks_count: Optional[int] = None
    """
    Количество входящих ссылок с домена на анализируемый домен. Возможность
    фильтровать по полю: `да`
    """
...
class LinkRetrieveOutlinksDomainsViewDomainResponse(BaseModel):
