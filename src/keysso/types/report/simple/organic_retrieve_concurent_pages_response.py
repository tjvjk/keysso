...
__all__ = ["OrganicRetrieveConcurentPagesResponse", "Data"]
...
class Data(BaseModel):
    ...
    """URL страницы Возможность фильтровать по полю: `да`"""


class OrganicRetrieveConcurentPagesResponse(BaseModel):
