...
__all__ = ["LinkRetrieveBacklinksResponse", "Data"]
...
class Data(BaseModel):
    ...
    """
    IP адрес страницы, которая ссылается на анализируемый сайт. Возможность
    фильтровать по полю: `да`
    """
    ...
    """
    Тег «title» страницы, которая ссылается на анализируемый сайт. Возможность
    фильтровать по полю: `да`
    """
    ...
    URL `0` - архивная – при повторном обходе источника ссылка не была обнаружена,
...
class LinkRetrieveBacklinksResponse(BaseModel):
