...
__all__ = ["SimpleRetrieveSimilarkeysResponse", "Data", "DataWizards"]
...
class Data(BaseModel):
    ...
    """Степень похожести запроса на исходный Возможность фильтровать по полю: `да`"""
    ...
    kei: Optional[int] = None
    """Индекс эффективности ключевого слова Возможность фильтровать по полю: `да`"""
...
class SimpleRetrieveSimilarkeysResponse(BaseModel):
